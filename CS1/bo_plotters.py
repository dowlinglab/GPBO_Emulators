...
def path_name(emulator, fxn, set_lengthscale, t, obj, LOO, LSO, sep_fact):
    """
    names a path
    ...
    fxn_dict = {"LOO_Plots_3_Input":"/3_Input_GP_Analysis" , "LSO_LOO_Analysis":"/Sep_Fact_SA" , "plot_obj_abs_min":"/Min_SSE_Conv" , "plot_org_train":"/org_TP", "value_plotter":"/"+ str(title_save), "plot_sep_fact_min":"/Sep_Analysis"}
    plot = fxn_dict[fxn]
...
#         path_org = "Test_Figs"+"/Sep_Analysis2"+"/Figures"
    ...
    path_end = Emulator + obj_str + len_scl + plot +sep_fact_str     
