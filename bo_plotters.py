...
def y_plotter_basic2(test_mesh, z, p_true, p_GP_opt,train_p,title="y",plot_train=True):
    '''
    Helper function for basic_plotter. Calls basic_plotter specifically for plotting y values.
    ...
    -------
        plt.show(), A heat map of test_mesh and z (y values)
    '''
    return basic_plotter2(test_mesh, z, p_true, p_GP_opt,title,train_p,plot_train)

def ei_plotter_basic2(test_mesh, z, p_true, p_GP_opt,train_p,plot_train=True):
    """
    Helper function for basic_plotter. Calls basic_plotter specifically for plotting expected improvement values.
...
def stdev_plotter_basic2(test_mesh, z, p_true, p_GP_opt,train_p,plot_train=True):
    '''
    Helper function for basic_plotter. Calls basic_plotter specifically for plotting standard deviation values.
...
def basic_plotter2(test_mesh, z, p_true, p_GP_opt,title,train_p,plot_train=True):
    '''
    Plots heat maps for 2 input GP
    Parameters
    ----------
