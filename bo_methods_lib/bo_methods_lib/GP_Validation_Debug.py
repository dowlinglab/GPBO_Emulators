...
def LOO_Analysis(all_data, Xexp, Yexp, true_model_coefficients, true_p, emulator, obj, Case_Study, skip_param_types = 0, set_lengthscale = None, train_iter = 300, noise_std = 0.1, verbose = False, DateTime = None, save_figure= True, plot_axis = None, normalize = False, bounds_p = None, bounds_x = None, CutBounds = False):  
    """
...
#             print("Loop")
    ...
    if emulator == False:
        ...
        #Plot GP vs y_sim
        LOO_Plots_3_Input(index_list, y_model_tj_xj_list, y_sim_tj_xj_list, y_model_stdev_tj_xj_list, Case_Study, DateTime, set_lengthscale, save_figure, normalize = normalize, CutBounds = CutBounds)
