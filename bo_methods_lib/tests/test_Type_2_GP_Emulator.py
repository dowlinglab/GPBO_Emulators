...
set_train_test_data_list = [[gp_emulator1_e, cs_params1],
...
train_gp_list = [[cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, 1, 1, np.ones(3), 1],
                 [cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, 2, 1, np.ones(3)*2, 1],
                 [cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, 2, 2, np.ones(3)*2, 2]]
...
train_gp_opt_list = [[cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, None, 1],
                     [cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, 1, None],
                     [cs_params1, Type_2_GP_Emulator, sim_data1, val_data1, 2, None]]
...
#This test function tests whether calc_best_error checker works correctly
                            #gp emulator, cs_params, exp_data, sim_sse_data
calc_best_error_list = [[gp_emulator1_e, cs_params1, exp_data1, sim_sse_data1],
                        [gp_emulator2_e, cs_params2, exp_data2, sim_sse_data2]]
@pytest.mark.parametrize("gp_emulator, cs_params, exp_data, sim_sse_data", calc_best_error_list)
def test_calc_best_error(gp_emulator, cs_params, exp_data, sim_sse_data):
    train_data, test_data = gp_emulator.set_train_test_data(cs_params)
