...
def test_gen_y_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, expected):
    ...
    data = simulator.gen_sim_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, sep_fact)
    #generate y_data
...
def test_sim_data_to_sse_sim_data(method, sim_data, exp_data, expected_arr, expected_val):
    sse_sim_data = simulator.sim_data_to_sse_sim_data(method, sim_data, exp_data, sep_fact)
...
def test_sim_data_to_sse_sim_val_data(method, sim_data, exp_data, gen_val_data, y_generated):
    sim_data = simulator.gen_sim_data(1, 1, Gen_meth_enum(2), Gen_meth_enum(2), sep_fact, gen_val_data)
    exp_data = simulator.gen_exp_data(1, Gen_meth_enum(2))
    sse_sim_data = simulator.sim_data_to_sse_sim_data(method, sim_data, exp_data, sep_fact, gen_val_data)
...
def test_gen_sim_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, expected):
    sim_data = simulator2.gen_sim_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, sep_fact)
    assert len(sim_data.theta_vals) == len(sim_data.y_vals) == expected, "Need same number of theta_vals and y_vals generated"
...
def test_gen_y_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, expected):
    #Generate feature data
    data = simulator2.gen_sim_data(num_theta_data, num_x_data, gen_meth_theta, gen_meth_x, sep_fact)
    #generate y_data
